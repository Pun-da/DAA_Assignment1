...
if __name__ == "__main__":
    ...
    file1 = open("generate_test1.txt", "r")
    ...
    file2 = open("generate_test2.txt", "w+")
    print(len(pset), file = file2)

    # listtostr = ''.join([str(elem) for elem in pset])
    
    for i in pset:
        print(*i, sep = " ", file = file2)
